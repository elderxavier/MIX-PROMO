		...
		<div class="conteudo-centro">
			<div id="barra-lateral">
				...
				<ul class="menu-lateral-interno">
					...
					<a href="slide-3.php"><li class="ativo-menu-lateral-interno">Slide 3</li></a>
			...
			<div class="conteudo-interno">
				...
				<form action="funcoes/add-slide-3.php" enctype="multipart/form-data" method="POST" target="iAjax">
					<?php
					...
					?>
					<img id="preview_slide_principal_3" alt="" src="<?php if($dados["slide3"] != ""){echo "../admin/imagens/slide/".$dados["slide3"];} ?>" >
					<div class="upload">Upload
						<input class="upload-campanhas" type="file" name="slide3" id="files" onchange="preview_slide_principal_tres(this);">
					</div>
					<input style="margin-top: 10px;" type="text" class="campo" name="link3" placeholder="ex: http://www.link.com.br" value="<?php if($dados2['link3'] != ""){echo $dados2["link3"];} ?>"/>
