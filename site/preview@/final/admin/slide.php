		...
		<div class="conteudo-centro">
			<div id="barra-lateral">
				...
				<ul class="menu-lateral-interno">
					<a href="slide.php"><li class="primeira-li ativo-menu-lateral-interno">Slide 1</li></a>
			...
			<div class="conteudo-interno">
				...
				<form action="funcoes/add-slide.php" enctype="multipart/form-data" method="POST" target="iAjax">
					<?php
					...
					?>
					<img id="preview_slide_principal_1" alt="" src="<?php if($dados["slide1"] != ""){echo "../admin/imagens/slide/".$dados["slide1"];} ?>" >
					<div class="upload">Upload
						<input class="upload-campanhas" type="file" name="slide1" id="files" onchange="preview_slide_principal_um(this);">
					</div>
					<input style="margin-top: 10px;" type="text" class="campo" name="link1" placeholder="ex: http://www.link.com.br" value="<?php if($dados2['link1'] != ""){echo $dados2["link1"];} ?>" />
